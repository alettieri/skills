...
This directory records accepted architecture decisions for the repository.

Read these before revisiting module seams or proposing broad refactors:

- [ADR-0001: herdr-implement uses a workflow-level Herdr adapter](0001-herdr-implement-uses-workflow-level-herdr-adapter.md)
- [ADR-0002: herdr-implement uses a deep Agent lifecycle module](0002-herdr-implement-agent-lifecycle-module.md)
